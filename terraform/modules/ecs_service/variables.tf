...
variable "queue_arn" {
  type        = string
  description = "SQS queue ARN the application can consume and publish."
}


variable "queue_actions" {
  type        = set(string)
  description = "Exact SQS data-plane actions granted to this workload; use an empty set for migrations."
  default = [
    "sqs:DeleteMessage",
...
variable "enable_autoscaling" {
  type        = bool
  description = "Create Application Auto Scaling target and CPU policy."
  default     = true
}
